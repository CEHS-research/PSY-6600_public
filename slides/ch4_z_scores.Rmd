...
.large[LINK: [Probability Distribution Viewer](http://shiny.calpoly.sh/Prob_View/)]
...
(1) The .dcoral[probability] a randomly selected .nicegreen[student] is more than 1.63 m tall =  .coral[**.063**]
  
(2) The .dcoral[probability] a randomly selected .nicegreen[sample] of 16 students .nicegreen[average] more than 1.63 m tall = .coral[**< .001**]
