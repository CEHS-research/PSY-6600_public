...
---
# Linear Association: Strength & Direction
...
- order doesn't matter (no DV or IV)
- Parameter = $\rho$
- Statistic = r
...
- Procedure for obtaining *the* line that best fits data (Assuming relationship is best described as linear)
...
- .bluer[Y normally distributed around the PREDICTIONS]
  - Does NOT apply to Y overall: check with residuals
