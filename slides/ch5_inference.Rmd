...
- Report exact p-values *(usually 3 decimal places)*, except for `p < .001`
...
> **Conclusion:** The Shapiro-Wilks test on this sample provides **does** provide **evidence** that distribution of .dcoral[total oral condition at 4 weeks] in the population is **NOT** normally distributed, *W* = `r round(totalcw4_sw$stat, 2)`, `r numform::f_pval(totalcw4_sw$p.val, alpha = .001, digits = 3)`.
