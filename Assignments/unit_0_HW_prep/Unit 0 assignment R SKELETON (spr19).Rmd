...
## Question 0: Import the data from an Excel file
...
## Question 1: Declare and label categorical variables
...
## Question 3: Create a new bariable = `hr_base` / 60
...
## Question 4: Create two new versions of the stat quiz score
...
## Question 5a: Create a new variable that is the SUM of the 3 anxiety measures 
...
## Question 5b: Create a new variable that is the AVERAGE of the 3 heart rates 
...
## Question 6: Create a new variable that is the difference between `statquiz` and `Exp_sqz`
...
> For varaibles that were created multiple ways (5a, 5b), choose one way only. 
